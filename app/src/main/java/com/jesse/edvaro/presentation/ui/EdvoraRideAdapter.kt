...
class EdvoraRideAdapter(private var rides: List<Ride>?, private val context: Context,
    ...
    ListAdapter<Ride, EdvoraRideAdapter.EdvoraRideViewHolder>(RideDiffUtil()) {
    ...
    override fun onBindViewHolder(holder: EdvoraRideViewHolder, position: Int) {
        holder.setData(currentList[position], context, getDistance)
    }
...
class RideDiffUtil: DiffUtil.ItemCallback<Ride>(){
